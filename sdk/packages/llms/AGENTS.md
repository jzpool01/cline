---
description: Development guidance for the @tarogo/llms package.
globs: "src/**/*.ts,src/**/*.tsx,*.md"
alwaysApply: true
---

# @tarogo/llms Development Guidance
...
- Do not build a broad Tarogo-maintained model capability or behavior registry.
