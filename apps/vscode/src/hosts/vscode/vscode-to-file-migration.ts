 ...
 * that data to the shared file-backed stores in ~/.tcode/data/ so all platforms
 ...
 *   globalStorageFsPath is still the VSCode-managed path (not ~/.tcode/data/),
 ...
 *   to ~/.tcode/data/ so that tasks created in VSCode are visible in CLI/JetBrains
