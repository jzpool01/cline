...
import type { TcodeAccountSnapshot } from "./tcode-account";
import type {
...
export interface TuiProps {
	...
	loadTcodeAccount: () => Promise<TcodeAccountSnapshot>;
	switchTcodeAccount: (organizationId?: string | null) => Promise<void>;
	loadConfigData: (
...
export const MAX_BUFFERED_LINES = 2000;
