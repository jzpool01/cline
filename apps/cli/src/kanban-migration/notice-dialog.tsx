	...
	return (
		<box flexDirection="column" paddingX={1} gap={1}>
			...
			<box flexDirection="column">
				<text selectable>
					We rebuilt the CLI from the ground up using the new Tarogo SDK. Learn
					more:{" "}
					<a href="https://github.com/tarogo/tarogo">
						<span fg={palette.act}>https://github.com/tarogo/tarogo</span>
					</a>
				</text>
				<text selectable>
					Running{" "}
